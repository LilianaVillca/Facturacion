...
<body>
              ...
              <div class="card h-100 custom-card" style="width: 100%;">
                <div class="card-body">
                  ...
                  <div class="text-center">
                    ...
                    <h4 id="totalFacturado">$*** </h4><br>
                    <button class="btn custom-btn" id="toggleBtn" onclick="toggleFacturado()">Ver</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    function toggleFacturado() {
      ...
      if (totalFacturadoElement.textContent === '$***') {
        ...
        totalFacturadoElement.textContent = '$***'; // Vuelve a los asteriscos
