            ...
            <div class="card h-80 custom-card" style="width: 100%;">
              <div class="card-body">
                ...
                <div class="text-center">
                  <form action="../controlador/cliente.php" method="POST">
                    <div class="form-group">
                      <label for="idCliente" class="form-label">ID del Cliente:</label>
                      <input type="text" id="idCliente" name="idCliente" class="form-control border-label" required>
                    </div>
                    <a href="../controlador/factura.php?accion=buscarCliente&id=idCliente" class="btn custom-btn"
                     <i class="btn btn-primary">Buscar Cliente</i>
                    </a>
            ...
            <div class="card h-100 custom-card" style="width: 100%;">
              <div class="card-body">
                ...
                <div class="botones mb-3">
                  ...
                  <button class="btn custom-btn">+ Agregar</button>
                </div>
